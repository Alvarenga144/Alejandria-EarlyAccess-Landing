...
const Hero = () => {
    return(
        <div className="w-full text-[#000000] justify-center border-b border-b-purple-950 pb-20">
            <div className="max-w-[900px]  md:mt-[120px]  sm:mt-[100px] mt-[80px] w-full mx-auto text-center flex flex-col">
                ...
                <h3 className="md:text-4xl sm:text-3xl text-xl font-black drop-shadow-2xl">La nueva frontera del internet</h3>
                <p className="md:text-xl sm:text-md text-md text-[#616161] px-2 mt-8 drop-shadow-2xl">
