        ...
        <div id="efective-sms-section" className="w-full py-4 px-4 justify-center">
            ...
            <div class="max-w-[900px] mx-auto
                ...
                <div class="md:row-span-1 md:col-span-1
                            ...
                            px-4">
                    <img className="md:w-full mx-auto px-4" src={InfoGroup1} alt="/" />
                    <img className="md:w-full mx-auto px-4" src={InfoGroup2} alt="/" />
                    <img className="md:w-full mx-auto px-4" src={InfoGroup3} alt="/" />
                </div>
            </div>
