...
const Facts = () => {
    ...
    return (
        <div id="comunity-section" className="w-full text-[#1a1e22] justify-center md:py-20 pt-8 pb-14">
            <div className="max-w-[1100px] w-full mx-auto text-center flex flex-col">

                <div class="md:max-w-[60%]
                            sm:max-w-[70%]
                            max-w-[90%] text-center justify-center m-auto" data-aos="zoom-out">
                    <h2 className="md:text-2xl sm:text-xl
                                   text-xl text-[#1a1e22] font-bold drop-shadow-2xl">La comunidad nos apoyó desde el inicio, ahora vamos a por más que una app, ¡Vamos por el futuro! 🚀</h2>
                </div>
                ...
                <div className="md:grid md:grid-cols-4 md:gap-4 md:my-14 md:mx-4
                    ...
                    <div className="border border-[#ADADAD] rounded-lg max-w-[260px] min-h-[160px] px-3 pt-8 pb-6" data-aos="fade-right" data-aos-duration="400" >
                        <img className="max-w-[40px] mx-auto" src={GlobeSVG} alt="/" />
                        <h2 className="md:text-xl sm:text-md text-md mt-2 text-[#1a1e22] font-bold tracking-wide">+20 Países</h2>
                    ...
                    <div className="border border-[#ADADAD] rounded-lg max-w-[260px] min-h-[160px] px-3 pt-8 pb-6" data-aos="fade-right" data-aos-duration="600">
                        <img className="max-w-[40px] mx-auto" src={IdeaSVG} alt="/" />
                        <h2 className="md:text-xl sm:text-md text-md mt-2 text-[#1a1e22] font-bold tracking-wide">Sugerencias</h2>
                    ...
                    <div className="border border-[#ADADAD] rounded-lg max-w-[260px] min-h-[160px] px-3 pt-8 pb-6" data-aos="fade-right" data-aos-duration="800">
                        <img className="max-w-[40px] mx-auto" src={DevicesSVG} alt="/" />
                        <h2 className="md:text-xl sm:text-md text-md mt-2 text-[#1a1e22] font-bold tracking-wide">Equipo profesional</h2>
                    ...
                    <div className="border border-[#ADADAD] rounded-lg max-w-[260px] min-h-[160px] px-3 pt-8 pb-6" data-aos="fade-right" data-aos-duration="1000">
                        <img className="max-w-[40px] mx-auto" src={LibrarySVG} alt="/" />
                        <h2 className="md:text-xl sm:text-md text-md mt-2 text-[#1a1e22] font-bold tracking-wide">Socios</h2>
